...
import (
	...
	"gitserver/kubernetes/inspur-cloud-controller-manager/test/pkg/fake"
...
var _ = Describe("Loadbalance", func() {
	...
	BeforeEach(func() {
		...
		service := `{
			...
			"metadata": {
				...
				"namespace": "default",
				"annotations": {
					"service.beta.kubernetes.io/incloud-load-balancer-type": "0"
				}
			},
			"spec": {
				"selector": {
	...
	It("Should delete old listeners when changing service ports", func() {
		testService.Annotations["service.beta.kubernetes.io/incloud-load-balancer-eip-source"] = "auto"
	...
	It("Should use avaliable ip", func() {
		testService.Annotations["service.beta.kubernetes.io/incloud-load-balancer-eip-source"] = "use-available"
		lbexec := fake.NewFakeQingCloudLBExecutor()
		sgexec := fake.NewFakeSecurityGroupExecutor()
	...
	It("Should follow the topology", func() {
		testService.Annotations["service.beta.kubernetes.io/incloud-load-balancer-eip-ids"] = "eip-vmldumvv"
		lbexec := fake.NewFakeQingCloudLBExecutor()
		dip := lbexec.AddEIP("eip-vmldumvv", "1.1.1.1")
		sgexec := fake.NewFakeSecurityGroupExecutor()
		lb, _ := loadbalance.NewLoadBalancer(&loadbalance.NewLoadBalancerOption{
		...
		lb.GetService().Annotations["service.beta.kubernetes.io/incloud-load-balancer-type"] = "1"
		lb.Type = 1
	...
	It("Should be ok when in reuse mode", func() {
		...
		service := `{
			...
			"metadata": {
				...
				"namespace": "default",
				"annotations": {
					"service.beta.kubernetes.io/incloud-load-balancer-eip-ids": "eip-vmldumvv",
					"service.beta.kubernetes.io/incloud-load-balancer-type": "0",
					"service.beta.kubernetes.io/incloud-load-balancer-eip-strategy": "reuse"
				}
			},
			"spec": {
				"selector": {
