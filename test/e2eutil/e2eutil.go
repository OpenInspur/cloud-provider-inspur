...
func GetIncloudService() (*pkg.InCloud, error) {
...
func WaitForLoadBalancerDeleted(lbapi *pkg.InCloud, name string) error {
	unaccept1 := "pending"
	unaccept2 := "active"
	...
	output, err := pkg.describeLoadBalancer(input)
	if err != nil {
		return err
	}
